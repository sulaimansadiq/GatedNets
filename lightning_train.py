...
parser.add_argument('--learning_rate_min',   type=float,             default=0.01,               help='minimum learning rate in scheduler')
...
parser.add_argument('--gate_loss_alpha_min', type=float,             default=0.0,                help='gate loss alpha')
parser.add_argument('--gate_loss_alpha',     type=float,             default=3.0,                help='gate loss alpha')
...
parser.add_argument('--constraints',         type=int,   nargs='+',  default=[4, 13],            help='number of constraints used in training')
