...
parser.add_argument('--constraints',        type=list,  default=[3, 6, 9, 13],  help='number of constraints used in training')
...
trainset = CIFAR10(root='H:\\mycode\\data', train=True, download=True, transform=transform)
validset = CIFAR10(root='H:\\mycode\\data', train=False, download=True, transform=transform)
